        ...
        return (
            <View style={styles.view}>
                ...
                <ScrollView> 
                    ...
                    <ShortListComponent title="Ultimos ingresos" update={this.updateScreen.bind(this)} navigation={this.state.navigation} editScreen={"EditIncomeScreen"} items={this.state.lastestIncomes} viewAllScreen={"IncomesScreen"} getAll={getAllIncomes} getTotal={getTotalIncomesAmount} user_email={this.state.user.email}/>
                </ScrollView>
